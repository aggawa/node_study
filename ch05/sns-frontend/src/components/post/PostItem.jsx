...
function PostItem({ post, isAuthenticated, user }) {
   ...
   const onClickDelete = (id) => {
      const result = confirm('삭제하시겠습니까?') // confirm 삭제 확인
   ...
   return (
      <Card style={{ margin: '20px 0' }}>
         {/* http://localhost:8000/뮤츠1752547107194.jpg */}
         ...
         <CardActions>
            ...
            {/* isAuthenticated가 true(로그인이 된 상태) 이면서 post.user.id와 user.id가 같을때 렌더링 => 내가 작성한 게시글만 수정, 삭제 */}
