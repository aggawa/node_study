...
app.use(
   cors({
      origin: 'http://localhost:5173', // 특정 출처만 request 허용 (프론트엔드 주소)
      credentials: true, // 쿠키, 세션등 인증 정보 허용
   })
)
...
app.use('/member', memberRouter) // localhost:8000/auth
app.use('/board', boardRouter) // localhost:8000/post
